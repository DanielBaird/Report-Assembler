...
(function() {
  ...
  dataview = new RA.Views.DatasetFull({
    model: data
  });
  ...
  data.set({
    name: 'freshly renamed data'
  });

  $(function() {
    var docView;
    return docView = Backbone.View.extend({
      el: $('.radoc').first(),
      initialize: function() {
      ...
      render: function() {
        return $(this.el).append('<ul> <li> a doc </li> </ul>');
      }
    });
  });
